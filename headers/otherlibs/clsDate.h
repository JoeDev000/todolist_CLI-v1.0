...
public:
	clsDate();
	clsDate(string);
	clsDate(short, short, short);
	clsDate(short, short);
	clsDate(short, short, short, short, short, short);
//Set - Get
	void SetSec(short Sec) { this->Sec = Sec; }
	short GetSec() { return Sec; }
	void SetMin(short Min) { this->Min = Min; }
	short GetMin() { return Min; }
	void SetHour(short Hour) { this->Hour = Hour; }
  ...
  void Print() { cout << DateToString() /* returns current object date */ << endl; }

	static clsDate GetSystemDate();

    static	bool IsValidDate(clsDate);
	
	bool IsValidDate() { return IsValidDate(*this); /* is valid date for the current object */ }

	static string DateToString(clsDate Date) 
		{ return  to_string(Date.Day) + "/" + to_string(Date.Month) + "/" + to_string(Date.Year); }

  string DateToString() 
		{ return  DateToString(*this); /* Current Object */ }

	static bool isLeapYear(short Year)
		{ return (Year % 4 == 0 && Year % 100 != 0) || (Year % 400 == 0); }

	bool isLeapYear()
		{ return isLeapYear(Year); /* Current Object */ }

	static short NumberOfDaysInAYear(short Year)
		{ return  isLeapYear(Year) ? 365 : 364; }

	short NumberOfDaysInAYear()
		{ return  NumberOfDaysInAYear(Year); /* Current Object */ }

	static short NumberOfHoursInAYear(short Year)
		{ return  NumberOfDaysInAYear(Year) * 24; }

	short NumberOfHoursInAYear()
		{ return  NumberOfHoursInAYear(Year); /* Current Object */ }

	static int NumberOfMinutesInAYear(short Year)
		{ return  NumberOfHoursInAYear(Year) * 60; }

	int NumberOfMinutesInAYear()
		{ return  NumberOfMinutesInAYear(Year); /* Current Object */ }

	static int NumberOfSecondsInAYear(short Year)
		{ return  NumberOfMinutesInAYear(Year) * 60; }

	int NumberOfSecondsInAYear()
		{ return  NumberOfSecondsInAYear(); /* Current Object */ }

	static short NumberOfDaysInAMonth(short, short);

	short NumberOfDaysInAMonth() 
		{ return NumberOfDaysInAMonth(Month, Year); /* Current Object */ }

	static short NumberOfHoursInAMonth(short Month, short Year)
		{ return  NumberOfDaysInAMonth(Month, Year) * 24; }

	short NumberOfHoursInAMonth()
		{ return  NumberOfDaysInAMonth(Month, Year) * 24; /* Current Object */ }

	static int NumberOfMinutesInAMonth(short Month, short Year)
		{ return  NumberOfHoursInAMonth(Month, Year) * 60; }

	int NumberOfMinutesInAMonth()
		{ return  NumberOfHoursInAMonth(Month, Year) * 60; /* Current Object */ }

	static int NumberOfSecondsInAMonth(short Month, short Year)
		{ return  NumberOfMinutesInAMonth(Month, Year) * 60; }

	int NumberOfSecondsInAMonth()
		{ return  NumberOfMinutesInAMonth(Month, Year) * 60; /* Current Object */ }

	static short DayOfWeekOrder(short, short, short);

	short DayOfWeekOrder()
		{ return DayOfWeekOrder(Day, Month, Year); /* Current Object */ }
	...
	string DayShortName() { /* Current Object */
		string arrDayNames[] = { "Sun","Mon","Tue","Wed","Thu","Fri","Sat" };
		return arrDayNames[DayOfWeekOrder(Day, Month, Year)];
	}
	...
	static string TimeToString(clsDate D) {
		string strTime = "";
		strTime += to_string(D.Hour) + ":";
		strTime += to_string(D.Min) + ":";
		strTime += to_string(D.Sec);
		return strTime;
	}

	static clsDate GetSystemDateAndTime() {
		clsDate D = GetSystemDate();

		std::time_t t = std::time(nullptr);
    std::tm* timeinfo = std::localtime(&t);

    D.Hour = timeinfo->tm_hour;
    D.Min = timeinfo->tm_min;
    D.Sec = timeinfo->tm_sec;

		return D;
	}

	static string getSystemDateTime_string() {
		clsDate D = GetSystemDateAndTime();
		
		string result = "";
		result += DateToString(D);
		result += " ";
		result += to_string(D.Hour);
		result += ":";
		result += to_string(D.Min);
		// result += " - ";
		// result += to_string(D.Sec);
...
clsDate::clsDate(short DateOrderInYear, short Year) {
	clsDate Date1 = GetDateFromDayOrderInYear(DateOrderInYear, Year); /* This will construct a date by date order in year */
	Day = Date1.Day;
	Month = Date1.Month;
	Year = Date1.Year;
}
...
clsDate clsDate::GetSystemDate() {
	...
	return clsDate(Day, Month, Year); /* use the paramitrized constructor to create an object and return it */
}
